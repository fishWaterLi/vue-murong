      ...
      <div class="page-login--content" flex="dir:top main:justify box:justify">
        <div class="page-login--content-header" flex="main:justify box:justify">
          <p class="page-login--content-header-side">
            <span class="page-login--content-header-side-text" style="opacity: 0;">
        ...
        <div class="page-login--content-main" flex="dir:top main:center cross:center">
          <!-- logo -->
          <img class="page-login--logo" src="./image/murong.jpg" />
          <!-- 表单 -->
          <div class="page-login--form">
            <el-card shadow="never">
              <el-form ref="loginForm" label-position="top" :rules="rules" :model="form" size="default">
                ...
                <el-button class="button-login" size="default" type="primary" @click="submit">{{ $t('login.form.textSubmitButton') }}</el-button>
              </el-form>
            </el-card>
...
<script>
  ...
  import { getUUID } from '@/common/murong'
  ...
  export default {
    ...
    computed: {
      ...
      // 验证码图片地址
      captchaPath() {
        return `${window.SITE_CONFIG['apiURL']}captcha.jpg?uuid=${this.form.uuid}`
      }
    },
    created() {
      // 刷新验证码和 uuid
